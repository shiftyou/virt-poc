...
|----------|-------------|
| [AIRGAP.md](../AIRGAP.md) | Air-gapped preparation guide |
| [download.sh](../download.sh) | Download required files |
| [package.sh](../package.sh) | Create distribution tarball |
...
| Red Hat build of Perses (via COO) | [perses-coo.md](operators/perses-coo.md) |
